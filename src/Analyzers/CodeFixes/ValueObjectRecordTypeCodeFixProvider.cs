...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ValueObjectRecordTypeCodeFixProvider)), Shared]
public class ValueObjectRecordTypeCodeFixProvider : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds => [ValueObjectRecordTypeAnalyzer.DiagnosticId];
    ...
    private static async Task<Document> ConvertToRecordAsync(Document document, ClassDeclarationSyntax classDeclaration, CancellationToken cancellationToken)
    {
