...
public class ValueObjectSerializationTests
{
    ...
    public async Task Email_ShouldDeserializeFromPlainString()
    {
        ...
        // Act
        Email? email = JsonSerializer.Deserialize<Email>(json, _options);
    ...
    public async Task Cpf_ShouldSerializeAndDeserialize()
    {
        ...
        // Act
        Cpf? deserialized = JsonSerializer.Deserialize<Cpf>(json, _options);
    ...
    {
        // Arrange
        Url url = Url.Create("https://google.com");
        string json = JsonSerializer.Serialize(url, _options);

        // Act
        Url? deserialized = JsonSerializer.Deserialize<Url>(json, _options);
