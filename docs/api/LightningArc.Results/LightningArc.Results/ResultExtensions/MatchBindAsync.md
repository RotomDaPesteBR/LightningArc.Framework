# ResultExtensions.MatchBindAsync method (1 of 14)

Maps a synchronous [`Result`](../Result.md) using a delegate that receives the original result.

```csharp
public static Task<Result> MatchBindAsync(this Result result, Func<Result, Task<Result>> success, 
...
# ResultExtensions.MatchBindAsync method (2 of 14)
...
```csharp
public static Task<Result> MatchBindAsync(this Result result, Func<Result> success, 
    Func<Error, Task<Result>> failure)
```
...
# ResultExtensions.MatchBindAsync method (3 of 14)

Maps a non-generic result (without value) by applying asynchronous functions, returning a Task&lt;Result&gt;.

```csharp
public static Task<Result> MatchBindAsync(this Result result, Func<Task<Result>> success, 
    Func<Error, Task<Result>> failure)
```
...
# ResultExtensions.MatchBindAsync method (4 of 14)
...
```csharp
public static Task<Result> MatchBindAsync(this Task<Result> resultTask, 
    Func<Result, Task<Result>> success, Func<Error, Task<Result>> failure)
```
...
# ResultExtensions.MatchBindAsync method (5 of 14)
...
```csharp
public static Task<Result> MatchBindAsync(this Task<Result> resultTask, Func<Result> success, 
    Func<Error, Task<Result>> failure)
```
...
# ResultExtensions.MatchBindAsync method (6 of 14)

Awaits a Task&lt;Result&gt; and maps the result using asynchronous functions, returning a Task&lt;Result&gt;.

```csharp
public static Task<Result> MatchBindAsync(this Task<Result> resultTask, Func<Task<Result>> success, 
    Func<Error, Task<Result>> failure)
```
...
# ResultExtensions.MatchBindAsync&lt;TOut&gt; method (7 of 14)
...
```csharp
public static Task<Result<TOut>> MatchBindAsync<TOut>(this Task<Result> resultTask, 
...
# ResultExtensions.MatchBindAsync&lt;TIn,TOut&gt; method (8 of 14)

Maps a synchronous [`Result`](../Result-1.md) using a delegate that receives the original result.

```csharp
public static Task<Result<TOut>> MatchBindAsync<TIn, TOut>(this Result<TIn> result, 
    Func<Result<TIn>, Task<Result<TOut>>> success, Func<Error, Task<Result<TOut>>> failure)
```
...
# ResultExtensions.MatchBindAsync&lt;TIn,TOut&gt; method (9 of 14)
...
```csharp
public static Task<Result<TOut>> MatchBindAsync<TIn, TOut>(this Result<TIn> result, 
    Func<Success<TIn>, Task<Result<TOut>>> success, Func<Error, Result<TOut>> failure)
```
...
# ResultExtensions.MatchBindAsync&lt;TIn,TOut&gt; method (10 of 14)

Maps the result by applying one of two asynchronous functions: one for success and one for failure.

```csharp
public static Task<Result<TOut>> MatchBindAsync<TIn, TOut>(this Result<TIn> result, 
    Func<Success<TIn>, Task<Result<TOut>>> success, Func<Error, Task<Result<TOut>>> failure)
```
...
# ResultExtensions.MatchBindAsync&lt;TIn,TOut&gt; method (11 of 14)

Awaits a Task&lt;Result&lt;TIn&gt;&gt; and maps the result. The success function receives the original [`Result`](../Result-1.md) (for re-sending or inspection), while failure receives the [`Error`](../Error.md).

```csharp
public static Task<Result<TOut>> MatchBindAsync<TIn, TOut>(this Task<Result<TIn>> resultTask, 
    Func<Result<TIn>, Task<Result<TOut>>> success, Func<Error, Task<Result<TOut>>> failure)
```
...
# ResultExtensions.MatchBindAsync&lt;TIn,TOut&gt; method (12 of 14)
...
# ResultExtensions.MatchBindAsync&lt;TIn,TOut&gt; method (13 of 14)
...
```csharp
public static Task<Result<TOut>> MatchBindAsync<TIn, TOut>(this Task<Result<TIn>> resultTask, 
    Func<Success<TIn>, Result<TOut>> success, Func<Error, Task<Result<TOut>>> failure)
```
...
# ResultExtensions.MatchBindAsync&lt;TIn,TOut&gt; method (14 of 14)
